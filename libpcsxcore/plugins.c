...
GPUrearmedCallbacks		GPU_rearmedCallbacks;
...
static int LoadGPUplugin(const char *GPUdll) {
  ...
  LoadGpuSym1(startFrame, "GPUstartFrame");
	...
	LoadGpuSym1(rearmedCallbacks, "GPUrearmedCallbacks");
