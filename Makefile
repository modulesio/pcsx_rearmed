...
OBJS += libpcsxcore/gte.o libpcsxcore/gte_divider.o libpcsxcore/pgxp_cpu.o libpcsxcore/pgxp_mem.o libpcsxcore/pgxp_gte.o libpcsxcore/pgxp_value.o libpcsxcore/pgxp_debug.o
ifeq "$(ARCH)" "arm"
